...
import com.example.chihurmnanyanwanevu.ussdbanking.adapters.RecyclerAdapter;
import com.example.chihurmnanyanwanevu.ussdbanking.animation.MyBounceInterpolator;
import com.example.chihurmnanyanwanevu.ussdbanking.data.ListData;
import com.example.chihurmnanyanwanevu.ussdbanking.mDataBase.DBAdapter;
import com.example.chihurmnanyanwanevu.ussdbanking.utils.AutoScrollViewPager;
...
public class HomeActivity extends AppCompatActivity
    ...
    public void addListItems(){
        ...
        mListData.add(new ListData("Access Bank","*901#","A","Sat 19","#2e002b"));
        mListData.add(new ListData("Diamond Bank","*710#","D","Sat 19","#004202"));
        mListData.add(new ListData("Ecobank","*326#","E","Sat 19","#0604ee"));
        mListData.add(new ListData("First Bank","*894#","F","Sat 19","#d50000"));
        mListData.add(new ListData("Fidelity","*770#","F","Sat 19","#d5008c"));
        mListData.add(new ListData("First City Monument Bank (FCMB) ","*329#","F","Sat 19","#be00d5"));
        mListData.add(new ListData("Guaranty Trust Bank (GTB) ","*737#","G","Sat 19","#3c00d5"));
        mListData.add(new ListData("Heritage Bank ","*322#","H","Sat 19","#008cd5"));
        mListData.add(new ListData("Keystone Bank ","*533#","K","Sat 19","#00d5af"));
        mListData.add(new ListData("Skye Bank ","*833#","S","Sat 19","#5684ee"));
        mListData.add(new ListData("Sterling Bank ","*822#","S","Sat 19","#007452"));
        mListData.add(new ListData("Stanbic IBTC ","*909#","S","Sat 19","#167400"));
        mListData.add(new ListData("United Bank for Africa (UBA)","*919#","U","Sat 19","#744f00"));
        mListData.add(new ListData("Unity Bank ","*7799#","U","Sat 19","#007374"));
        mListData.add(new ListData("Union Bank ","*826#","U","Sat 19","#740000"));
        mListData.add(new ListData("Wema Bank","*945#","W","Sat 19","#2e002b"));
        mListData.add(new ListData("Zenith Bank","*966#","Z","Sat 19","#004202"));
